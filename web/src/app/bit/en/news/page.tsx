...
import { getCmsNews, localizeNews } from "../../_data/news-server";
import { Reveal } from "../../_components/reveal";

/** Englische News-Übersicht – gleicher Aufbau wie /bit/news, Beiträge auf Englisch. */
...
export default async function EnglishNewsPage() {
  const posts = (await getCmsNews()).map((n) => localizeNews(n, "en"));
