...
export function ShareButtons({ title = "BIT" }: { title?: string }) {
  ...
  const links = [
    { label: t.linkedin, href: `https://www.linkedin.com/sharing/share-offsite/?url=${u}`, Icon: Linkedin },
    { label: t.facebook, href: `https://www.facebook.com/sharer/sharer.php?u=${u}`, Icon: Facebook },
    { label: t.x, href: `https://twitter.com/intent/tweet?url=${u}&text=${tt}`, Icon: Twitter },
    { label: t.mail, href: `mailto:?subject=${tt}&body=${u}`, Icon: Mail },
  ];
